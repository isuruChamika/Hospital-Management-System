...
{
    public partial class frmLabAddOut : Form
    {
        ...
        private void btnPSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int i = SQLConnectionManager.insrtUpdteDelt("INSERT INTO OUT_SAMPLE VALUES('" + txtPatientId.Text + "','" + cmbSample.Text + "','" + txtWardNo.Text + "','" + txtRoomNo.Text + "','" + dct + "','" + frmLogin.passingRoll + "',SYSDATETIME(),SYSDATETIME())");
